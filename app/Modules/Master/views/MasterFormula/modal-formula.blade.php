            <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="margin-bottom: 15px;padding-top: 15px; ">
              ...
              <div class="col-md-8 col-sm-8 col-xs-12">
                <div class="form-group">  
                  <input style="text-align: right;" readonly autocomplete="off" type="number" class="form-control input-sm" name="hasil_item" id="hasil_item" value="{{ number_format($item->fr_result,0,",",".") }}">
                </div>
              </div>
              ...
              <table class="table tabelan table-bordered table-hover dt-responsive" id="formula-detail" >
               ...
               <tbody>
                ...
                <tr>
                  <td>{{ $index + 1 }}</td>
                  <td>{{ $data->i_name }}</td>
                  <td>{{ number_format($data->f_value,0,",",".") }}</td>
                  <td>{{ $data->s_name }}</td>
                </tr>
                @endforeach
               </tbody>

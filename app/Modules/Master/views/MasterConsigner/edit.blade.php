...
<div id="page-wrapper">
   ...
   <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
      <div class="page-header pull-left" style="font-family: 'Raleway', sans-serif;">
         <div class="page-title">Edit Master Consigner</div>
      </div>
      <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
         <li><i class="fa fa-home"></i>&nbsp;<a href="{{ url('/home') }}">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
         <li><i></i>&nbsp;Master&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
         <li class="active">Master Consigner</li><li><i class="fa fa-angle-right"></i>&nbsp;Edit Master Consigner&nbsp;&nbsp;</i>&nbsp;&nbsp;</li>
      </ol>
      <div class="clearfix">
      </div>
   </div>
         ...
         <div class="row mbl">
            <div class="col-lg-12">
               ...
               <ul id="generalTab" class="nav nav-tabs">
                  <li class="active"><a href="#alert-tab" data-toggle="tab">Edit Master Consigner</a></li>
                           ...
                           <form id="form_suplier" method="POST">
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="margin-bottom: 20px; padding-top:30px;padding-bottom:20px;">
                                 <div class="col-md-2 col-sm-3 col-xs-12">
                                    ...
                                    <label class="tebal">Nama Consigner</label>
...
<script>
   ...
   function edit()
   {
      $.ajax({
         type: "POST",
         url: baseUrl + '/master/consigner/update/{{$data->c_id}}',
         data: $('#form_suplier').serialize(),
         success: function(a){
         if(a.status=="sukses")
         {
            toastr["success"]("Consigner Berhasil diupdate", "Sukses");
            window.location = (baseUrl+'/master/consigner/index');
         }
         },
            error: function(){

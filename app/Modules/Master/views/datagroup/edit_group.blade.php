                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="margin-bottom: 20px; padding-bottom:5px;padding-top:20px; ">
                                ...
                                <div class="col-md-4 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                      <input type="text" class="form-control input-sm" value="{{ $data->g_code }}" id="id" readonly="true" name="code">
                                      <input type="hidden" value="{{ $data->g_id }}" name="id">
                                  </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-4 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                      <input type="text" id="nama" name="nama" value="{{ $data->g_name }}" class="form-control input-sm" >
                                  </div>
                                </div>
                                <div class="col-md-12">
                                  ...
                                  <div class="form-group">
                                      <select name="akun" class="form-control select-2" id="item">
                                        ...
                                        @foreach ($item as $akun)
                                          @if ($akun->ak_id == $data->persediaan)
                                            <option value="{{ $akun->ak_id }}" selected>{{ $akun->nama_akun }}</option>
                                          @else
                                            <option value="{{ $akun->ak_id }}" >{{ $akun->nama_akun }}</option>
                                          @endif
                                        @endforeach
                                      </select>
                                  </div>

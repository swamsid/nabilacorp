            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
                        ...
                        <li class="active">Master Data Satuan</li><li><i class="fa fa-angle-right"></i>&nbsp;Form Master Data Satuan&nbsp;&nbsp;</i>&nbsp;&nbsp;</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="margin-bottom: 20px; padding-bottom:5px;padding-top:20px; ">
                                ...
                                <div class="col-md-4 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                      <input type="text" class="form-control input-sm" value="{{ $data->s_code }}" id="id" readonly="true" name="id">
                                ...
                                <div class="col-md-4 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                    <div class="input-icon right">
                                      ...
                                      <input type="text" id="nama" name="nama" class="form-control input-sm" value="{{ $data->s_name }}"> 
                                    </div>                           
                                  </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                    <div class="input-icon right">
                                      <i class="glyphicon glyphicon-user"></i>
                                      <input type="text" id="nama" name="detail" class="form-control input-sm" value="{{ $data->s_detname }}"> 
                                    </div>                           
                                  </div>
                                </div>
                              </div>

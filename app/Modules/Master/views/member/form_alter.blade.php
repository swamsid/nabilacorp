                     ...
                     <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: -10px;margin-bottom: 15px;">
                           ...
                           <div class="col-md-7 col-sm-6 col-xs-4 " align="right" style="margin-top:5px;margin-right: -25px;">
                              <a href="{{ url('master/membership/member') }}" class="btn">
                              ...
                              {{ csrf_field() }}
                                 ...
                                 <div class="row">
                                    <article class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                       ...
                                       <div class="form-group">
                                          <label class="col-xs-4 col-lg-4 control-label text-left">Kategori Member</label>
                                          <div class="col-xs-8 col-lg-8 inputGroupContainer">
                                             <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-users" style="width: 15px"></i></span>
                                                <select name="c_class" id="c_class" class="form-control" style="">
                                                   <option value="">-- Pilih Kategori Member --</option>
                                                   @foreach( $m_price_group as $unit )
                                                      <option value="{{ $unit->pg_id }}">{{ $unit->pg_name }}</option>
                                                   @endforeach
                                                </select>
                                             </div>
                                          </div>
...
@include('Master::member/js/form_functions')
@include('Master::member/js/form_commander')

<script>
   $(document).ready(function(){
         $('#c_class').val( {{ $m_customer->c_class != '' ? $m_customer->c_class : '""'}} );
         $('#c_class').trigger('change');
   });
</script>
@endsection
...
{  
    ...
    protected $fillable = ['it_id','it_comp','it_con','it_code','it_date','it_toko','it_note','it_total','it_keterangan','it_status','it_bayar','it_disc'];
    ...
    static function itemTitip($request){
      ...
      $itemTitip=d_item_titip::select( 'it_id',
                                       'it_date',
                                       'it_code',
                                       'it_keterangan',
                                       'it_total',
    ...
    static function dataTitip($id){            
             $itemTitip=d_item_titip::where('it_comp',Session::get('user_comp'))

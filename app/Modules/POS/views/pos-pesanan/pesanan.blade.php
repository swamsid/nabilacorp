    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="padding-top: 15px;" no>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="form-group">
              <input type="text" class="move up2 form-control input-sm" name="s_duedate" id="s_duedate" readonly="">
            </div>
          </div>
          <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="form-group">
              <input type="text" class="move up2 form-control input-sm reset" name="s_hp" id="s_hp">
            </div>
          </div>
          <div class="col-md-3 col-sm-6 col-xs-12">

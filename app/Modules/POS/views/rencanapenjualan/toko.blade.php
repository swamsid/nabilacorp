            ...
            <div class="col-md-12 tamma-bg" style="margin-top: 5px;margin-bottom: 5px;margin-bottom: 20px; padding-bottom:20px;padding-top:20px;">
               <div class="col-md-6">
                  ...
                  <div class="input-group input-group-sm" style="width: 100%;">
                     ...
                     <input type="text" class="form-control input-sm reset-seach" id="itemName">
                     <input type="text" class="form-control input-sm " name="i_id" id="i_id">
                     <input type="text" class="form-control input-sm reset-seach" name="i_code" id="i_code">
                     <input type="text" class="form-control input-sm reset-seach" id="i_price">
                     <input type="text" class="form-control input-sm reset-seach" name="s_satuan" id="s_satuan">
                     <input type="text" class="fComp form-control input-sm reset-seach" name="" id="fComp">
                     <input type="text" class="fPosition form-control input-sm reset-seach" name="" id="fPosition">
                  </div>
               </div>
               <div class="col-md-3">

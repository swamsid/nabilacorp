          ...
          <div class="col-md-3">
           <label class="control-label tebal">Jumlah</label>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" align="right">
                <button type="button" class="btn btn-xs btn-primary btn-disabled btn-flat" onclick="perbarui_d_shop_purchase_plan()">
      ...
      $(document).ready(function(){
        ...
        if(d_shop_purchaseplan_dt.length > 0) {
          for(var x = 0;x < d_shop_purchaseplan_dt.length;x++) {
            ...
            var sppdt_qty = data.sppdt_qty;
            var sppdt_satuan = "<input type='hidden' name='sppdt_satuan[]' value='" + data.s_id + "'>" + data.s_name;

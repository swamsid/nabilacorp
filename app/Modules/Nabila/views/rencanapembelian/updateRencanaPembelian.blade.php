...
<div class="row mbl">
   <div class="col-lg-12">
      ...
      <ul id="generalTab" class="nav nav-tabs">
         <li class="active"><a id="pembelian" href="#toko" data-toggle="tab">Update Rencana Pembelian</a></li>
      ...
      <div id="generalTabContent" class="tab-content responsive">
         ...
         <div id="toko" class="tab-pane fade in active">
            ...
            <div class="col-md-5 col-sm-6 col-xs-8">
              <h4>Form Update Rencana Pembelian</h4>
            </div>
            <div class="col-md-7 col-sm-6 col-xs-4" align="right" style="margin-top:5px;margin-right: -25px;">
              <a href="{{ url('/pembelian/rencanapembelian/rencana#list') }}" class="btn"><i class="fa fa-arrow-left"></i></a>
            </div>
          </div>

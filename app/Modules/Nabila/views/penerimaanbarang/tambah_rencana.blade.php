            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    <div class="page-header pull-left" style="font-family: 'Raleway', sans-serif;">
                        <div class="page-title">Tambah Penerimaan Barang</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
                        <li><i class="fa fa-home"></i>&nbsp;<a href="{{ url('/home') }}">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li><i></i>&nbsp;Penerimaan Barang&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="active">Penerimaan Barang&nbsp;&nbsp;</li><i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                        <li class="active">Tambah Penerimaan Barang</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
                    ...
                    <div id="tab-general">
                        <div class="row mbl">
                          ...
                          <ul id="generalTab" class="nav nav-tabs">
                            <li class="active"><a href="#alert-tab" data-toggle="tab">Tambah Penerimaan Barang</a></li>
                    ...
                    <div id="generalTabContent" class="tab-content responsive" >
                        ...
                        <div class="col-md-12 col-xs-12 col-sm-12">
                          <div class="col-md-6 col-sm-6 col-xs-6" style="margin-top: -10px;">
                            <div class="form-group">
                              <h4>Data Barang Penerimaan Barang Terlaris Bulan Lalu :</h4>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-6" align="right">
                            ...
                            <a href="{{ url('/penerimaanbarang/penerimaanbarang/rencana') }}" class="btn"><i class="fa fa-arrow-left"></i></a>
                      ...
                      <div class="col-md-12 col-xs-12 col-sm-12">
                        <div class="col-md-12 col-sm-12 col-xs-12">  
                          <div class="form-group">
                            <h4>Tambah Data Penerimaan Barang</h4>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12 col-xs-12 col-sm-12">  
                        <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="padding-bottom: : 10px;padding-top: 10px;margin-bottom: 10px;">      
                              ...
                              <div class="col-md-3 col-md-offset-2 col-sm-6 col-xs-12">
                                <label class="col-form-label">Jumlah Target Penerimaan Barang</label>
                              </div>
                          ...
                          <div class="table-responsive" style="margin-top: 10px;">
                            <table width="100%" class="table-hover table tabelan" cellspacing="0" id="data">
                              <thead>
                                ...
                                <th>Target Penerimaan Barang</th>
                              </thead>
                              <tbody>
                                <tr>
                                  <td>1</td>

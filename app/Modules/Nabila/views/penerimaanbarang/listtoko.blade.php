            ...
            <div style="padding-top: 20px;padding-bottom: 20px;">
               <div id="listPenerimaan Barang">
                     ...
                     <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                           <div class="modal-header" style="background-color: #e77c38;">
                              ...
                              <h4 class="modal-title" style="color: white;">Detail Penerimaan Barang</h4>
                           </div>
                  ...
                  <script type="text/javascript">
                     function editPenerimaan Barang(s_id,s_note,s_machine,s_date,s_duedate,s_finishdate,s_gross,s_disc_percent,s_disc_value,s_grand,s_ongkir,s_bulat,s_net,s_bayar,s_kembalian,s_customer,c_name,s_status,chek) {

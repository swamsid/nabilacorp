                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <form id="form_shop_terima_pembelian">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="padding-bottom: 10px;padding-top: 20px;margin-bottom: 15px;">
                                                            ...
                                                            <div class="col-md-3 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    <input type="text" readonly="" class="form-control input-sm" name="nota" value="{{ $d_shop_terima_pembelian->stb_code }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="col-md-3 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" readonly class="form-control input-sm" value="{{ $d_shop_terima_pembelian->m_name }}">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    <input class="form-control input-sm" type="text" id="stb_date" name="stb_date" autocomplete="off" value="{{ $d_shop_terima_pembelian->stb_date_label }}" readonly>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="stb_pid" id="" class="form-control" value="{{ $d_shop_terima_pembelian->stb_noreff }}" readonly>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    id="stb_sup" value="{{ $d_shop_terima_pembelian->s_company }}" readonly>
                                                                </div>
  ...
  $(document).ready(function(){
    ...
    for(i = 0; i < d_shop_terima_pembelian_dt.length;i++) {
            ...
            tabel_d_shop_terima_pembelian_dt.row.add([
              stbdt_item, stbdt_qty, stbdt_satuan, stbdt_price, subtotal, s_qty
            ]);
    }

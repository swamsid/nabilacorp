    ...
    <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div>
                <div class="form-horizontal">
                  <label for="stb_status" class="control-label">Status</label>
                <select id="stb_status" class="form-control">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" onclick="update_stb_status()">Submit</button>
            </div>
          </div>
    </div>
</div>
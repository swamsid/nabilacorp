<div id="penerimaangeneral" class="tab-pane fade in active">
            <div class="row">
               <div class="row">
                        ...
                        <div class="row">
                           <div class="form-group col-md-6">
                              <div class="input-group mb-3">
                                 <div class="input-group-addon">Tanggal PO</div>
               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="table-responsive">
                     <table class="table tabelan table-hover table-bordered" cellspacing="0" id="tabel_d_shop_terima_pembelian">
                        <thead>
                           <tr>
                              <th width="10%">Tanggal Penerimaan</th>
                              <th width="25%">Kode Penerimaan</th>
                              <th width="20%">Kode PO</th>

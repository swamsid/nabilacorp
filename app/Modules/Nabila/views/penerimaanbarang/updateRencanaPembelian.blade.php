...
<div class="row mbl">
   <div class="col-lg-12">
      ...
      <ul id="generalTab" class="nav nav-tabs">
         <li class="active"><a id="penerimaanbarang" href="#toko" data-toggle="tab">Update Penerimaan Barang</a></li>
      ...
      <div id="generalTabContent" class="tab-content responsive">
         ...
         <!-- /div #alert-tab -->
         <!-- Div #listtoko -->
         <!-- @include('penerimaanbarang.POSpenerimaanbarangToko.listtoko') -->
         <style type="text/css">
         </style>
         <div id="toko" class="tab-pane fade in active">
            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: -10px;margin-bottom: 15px;">  
            <div class="col-md-5 col-sm-6 col-xs-8">
              <h4>Form Update Penerimaan Barang</h4>
            </div>
            <div class="col-md-7 col-sm-6 col-xs-4" align="right" style="margin-top:5px;margin-right: -25px;">
              <a href="{{ url('/penerimaanbarang/penerimaanbarang/rencana#list') }}" class="btn"><i class="fa fa-arrow-left"></i></a>
            </div>
          </div>
            <form method="post" id="form_sales_order">
               <div class="row">
                  ...
                  <div class="col-md-12">
                     <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="padding-top: 15px;" no>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                           <div class="form-group">
                              <input type="hidden"  name="stb_id" id="stb_id" value="{{ $d_sales_order->stb_id }}">
                              <input type="text" class="form-control input-sm reset" name="s_note" id="s_note" value="{{ $d_sales_order->stb_code }}" disabled="">
                           </div>
                        </div>
                        <div class="col-md-2 col-sm-6 col-xs-12">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                           <div class="form-group">
                              <input type="hidden" id="stb_mem" class="form-control input-sm reset" name="stb_mem" readonly="" value="{{Auth::user()->m_id}}">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                           <div class="form-group">
                              <input class="form-control" type="" name="" value="{{$d_sales_order->stb_comp}}" disabled="">
                           </div>
                        </div>
                     </div>
               ...
               <div class="col-md-6 col-sm-6 col-xs-12" style="display: flex;justify-content: flex-end">
                  <label class="control-label tebal" for="penerimaanbarang">Total QTY</label>
               </div>
                        ...
                        <div class="modal-dialog">
                           ...
                           <div class="modal-content">
                              <div class="modal-header" style="background-color: #e77c38;">
                                 ...
                                 <h4 class="modal-title" style="color: white;">Proses Form Penerimaan Barang Toko</h4>
                              </div>

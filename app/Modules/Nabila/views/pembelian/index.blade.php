...
<div class="row mbl">
   <div class="col-lg-12">
      ...
      <ul id="generalTab" class="nav nav-tabs">
         <li class="active"><a id="list" href="#listtoko" data-toggle="tab">List Pembelian</a></li>
         <!-- 
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="col-md-3 col-sm-6 col-xs-12" align="right">
                  <button type="button" class="btn btn-xs btn-primary btn-disabled btn-flat" onclick="location.href = '{{ route('form_insert_shop_pembelian') }}'">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">                          
      <div class="table-responsive">
        <table class="table tabelan table-hover table-bordered" width="100%" cellspacing="0" id="tabel_d_shop_purchase_order">
              <thead>
                  <tr>                    
...
@include('Nabila::pembelian/includes/modal_alter_status')
...
@include('Nabila::pembelian/js/functions')
@include('Nabila::pembelian/js/commander')

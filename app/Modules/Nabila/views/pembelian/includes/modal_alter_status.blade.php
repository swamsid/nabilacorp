    ...
    <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div>
                <div class="form-horizontal">
                  <label for="spo_status" class="control-label">Status</label>
                <select id="spo_status" class="form-control">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" onclick="update_spo_status()">Submit</button>
            </div>
          </div>
    </div>
</div>
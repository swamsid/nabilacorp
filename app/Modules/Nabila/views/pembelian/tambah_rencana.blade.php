            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
                        ...
                        <li class="active">Pembelian&nbsp;&nbsp;</li><i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                    ...
                    <div id="tab-general">
                        <div class="row mbl">
                          ...
                          <ul id="generalTab" class="nav nav-tabs">
                            <li class="active"><a href="#alert-tab" data-toggle="tab">Tambah Pembelian</a></li>
                      ...
                      <div class="row">  
                        <div class="col-md-12 col-xs-12 col-sm-12">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-6" align="right">
                            ...
                            <a href="{{ url('/pembelian/pembelian/rencana') }}" class="btn"><i class="fa fa-arrow-left"></i></a>

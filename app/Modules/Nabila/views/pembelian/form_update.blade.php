 ...
 border-radius:0 !important;
      ...
      {{-- form input trigger --}}
            ...
            <div class="col-md-5 col-md-offset-7 col-sm-6 col-sm-offset-6 col-xs-12 tamma-bg" style="margin-bottom: 20px; padding-bottom:5px;padding-top: 10px;">
               ...
               <div class="col-md-6 col-sm-6 col-xs-12 ">
                  <div class="form-group">
                     <input type="text" id="spo_disc_value" name="spo_disc_value" value="{{ $d_shop_purchase_order->spo_disc_value }}" class="form-control input-sm reset" style="text-align: right;">
                  </div>
               </div>
               ...
               <div class="col-md-6 col-sm-6 col-xs-12 ">
                  <div class="form-group">
                     <input type="number" id="spo_tax_percent" name="spo_tax_percent" value="{{ $d_shop_purchase_order->spo_tax_percent }}"  class="form-control input-sm reset" style="text-align: right;">
                  </div>
               </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" align="right">
                <button type="button" class="btn btn-xs btn-primary btn-disabled btn-flat" onclick="perbarui_d_shop_purchase_order()">
...
<script>
  $(document).ready(function(){
    ...
    for(i = 0; i < d_shop_purchaseorder_dt.length;i++) {
            ...
            spodt_qtyconfirm = "<input type='number' name='spodt_qtyconfirm[]' value='" + unit.spodt_qtyconfirm + "' class='form-control'>";

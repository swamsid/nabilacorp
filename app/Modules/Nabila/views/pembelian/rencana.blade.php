                    ...
                    <div id="tab-general">
                        <div class="row mbl">
                          ...
                          <ul id="generalTab" class="nav nav-tabs">
                            <li class="active"><a href="#alert-tab" data-toggle="tab">Pembelian</a></li>
                      ...
                      <div id="alert-tab" class="tab-pane fade in active">
                          ...
                          <div class="row" style="margin-top: -20px;">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" align="right" style="margin-bottom: 15px;">
                              <a href="{{ url('/pembelian/pembelian/tambah_rencana') }}" class="btn btn-box-tool"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Pembelian</a>
                            </div>

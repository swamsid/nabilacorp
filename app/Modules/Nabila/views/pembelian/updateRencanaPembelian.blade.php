   @extends('main')
@section('content')
@include('Nabila::pembelian/js/format_currency')
<!--BEGIN PAGE WRAPPER-->
<div id="page-wrapper">
...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
   ...
   <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
      ...
      <li><i></i>&nbsp;<a href="{{url('pembelian/POSpembelian/POSpembelian')}}">Pembelian</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
...
<div class="row mbl">
   <div class="col-lg-12">
      ...
      <ul id="generalTab" class="nav nav-tabs">
         <li class="active"><a id="pembelian" href="#toko" data-toggle="tab">Update Pembelian</a></li>
      ...
      <div id="generalTabContent" class="tab-content responsive">
         ...
         <!-- /div #alert-tab -->
         <!-- Div #listtoko -->
         <!-- @include('pembelian.POSpembelianToko.listtoko') -->
         <style type="text/css">
         </style>
         <div id="toko" class="tab-pane fade in active">
            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: -10px;margin-bottom: 15px;">  
            <div class="col-md-5 col-sm-6 col-xs-8">
              <h4>Form Update Pembelian</h4>
            </div>
            <div class="col-md-7 col-sm-6 col-xs-4" align="right" style="margin-top:5px;margin-right: -25px;">
              <a href="{{ url('/pembelian/pembelian/rencana#list') }}" class="btn"><i class="fa fa-arrow-left"></i></a>
            </div>
          </div>
            <form method="post" id="form_sales_order">
               <div class="row">
                  ...
                  <div class="col-md-12">
                     <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="padding-top: 15px;" no>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                           <div class="form-group">
                              <input type="hidden"  name="spo_id" id="spo_id" value="{{ $d_sales_order->spo_id }}">
                              <input type="text" class="form-control input-sm reset" name="s_note" id="s_note" value="{{ $d_sales_order->spo_code }}" disabled="">
                           </div>
                        </div>
                        <div class="col-md-2 col-sm-6 col-xs-12">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                           <div class="form-group">
                              <input type="hidden" id="spo_mem" class="form-control input-sm reset" name="spo_mem" readonly="" value="{{Auth::user()->m_id}}">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                           <div class="form-group">
                              <input class="form-control" type="" name="" value="{{$d_sales_order->spo_comp}}" disabled="">
                           </div>
                        </div>
                     </div>
               ...
               <div class="col-md-6 col-sm-6 col-xs-12" style="display: flex;justify-content: flex-end">
                  <label class="control-label tebal" for="pembelian">Total QTY</label>
               </div>
               ...
               <!--      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="modal-dialog">
                           ...
                           <div class="modal-content">
                              <div class="modal-header" style="background-color: #e77c38;">
                                 ...
                                 <h4 class="modal-title" style="color: white;">Proses Form Pembelian Toko</h4>
                              </div>
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12" align="right">
                     ...
                     <button type="button" class="btn-primary btn perbarui" id="perbarui" onclick="perbarui_sales_order()">Perbarui</button>
...
<script>
   $(document).ready(function(){
      ...
      var d_salesorder_dt = {!! $d_salesorder_dt !!};
     

       var unit;
       for(x = 0;x < d_salesorder_dt.length;x++) {
            unit = d_salesorder_dt[x];

				...
				<div id="contentnya">
					...
					{{-- Judul Kop --}}
						...
						<table width="100%" border="0" style="border-bottom: 1px solid #333;" v-if="pageNow == 1" v-cloak>
				          <thead>
				            <tr>
				              <th style="text-align: left; font-size: 14pt; font-weight: 600; padding-top: 10px;" colspan="2">Analisa Pertumbuhan Aset</th>
				            </tr>
						...
						<table class="table" id="table-data" v-cloak>
							<thead>
								<tr>
									...
									<th width="20%" style="text-align: center; border: 1px solid #eee; background-color: #0099CC; color: white;">Nilai Di Awal Periode</th>
									<th width="20%" style="text-align: center; border: 1px solid #eee; background-color: #0099CC; color: white;">Penambahan Aset</th>
									<th width="20%" style="text-align: center; border: 1px solid #eee; background-color: #0099CC; color: white;">Pengurangan Aset</th>
									<th style="text-align: center; border: 1px solid #eee; background-color: #0099CC; color: white;">Nilai Akhir Aset</th>
								</tr>
							</thead>
								...
								<template v-for="(dta, index) in dataPrint">
									<tr>
										...
										<td style="font-weight: 600; text-align: right;">
											@{{ humanizePrice(dta.aset.saldo_awal) }}
										</td>

										<td style="font-weight: 600; text-align: right;">
											@{{ humanizePrice(dta.aset.penambahan) }}
										</td>

										<td style="font-weight: 600; text-align: right;">
											@{{ humanizePrice(dta.aset.pengurangan) }}
										</td>
    	...
    	<script type="text/javascript">
			...
			var app = 	new Vue({
				            ...
				            mounted: function(){
				            	...
				            	axios.get('{{route('analisa.keuangan.pertumbuhan_aset.data_resource')}}?'+that.url.searchParams)
			                            .then((response) => {
				            ...
				            methods: {
				            	...
				            	downloadPdf: function(evt){
				                    ...
				                    $('#pdfIframe').attr('src', '{{route('analisa.keuangan.pertumbuhan_aset.print.pdf')}}?'+that.url.searchParams)

...
<div style="padding-top: 20px;">
	...
	@if($_GET['jenis'] == 'rekap')
		<table class="table" width="100%" style="font-size: 9pt; border-collapse: collapse;">
			...
			<thead>
				<tr>
					...
					<th rowspan="2" width="22%" style="text-align: center; color: white; background-color: #0099CC; border: 1px solid #ffffff; padding: 5px;">Nama Debitur</th>
		...
		<table class="table" width="100%" style="font-size: 9pt; border-collapse: collapse; margin-top: 30px;">
			<thead>
				<tr>
					<th width="25%" colspan="2" style="text-align: center; background-color: #0099CC; color: #ffffff; border: 1px solid #ffffff; padding: 5px;">Total Seluruh Piutang</th>
	...
	@else
		...
		<table width="100%" style="border-collapse: collapse; font-size: 9pt;">
			<thead>
				<tr>
					<th colspan="4" style="text-align: center; background-color: #0099CC; color: white; padding: 5px; border: 1px solid #ffffff;">Total Seluruh Debitur</th>

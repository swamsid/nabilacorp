			...
			<div class="container-fluid" style="background: none; margin-top: 70px; padding: 10px 30px;">
				<div id="contentnya">
					...
					<?php 
						...
						$type = ($_GET['type'] == "Piutang_Customer") ? 'Customer' : 'Lain-lain';
					?>					
					...
					{{-- Judul Kop --}}
						...
						<table width="100%" border="0" style="border-bottom: 1px solid #333;" v-if="pageNow == 1" v-cloak>
				          <thead>
				            <tr>
				              <th style="text-align: left; font-size: 14pt; font-weight: 600; padding-top: 10px;" colspan="2">Laporan Piutang {{ $type }} ({{ $_GET['jenis'] }})</th>
				            </tr>
			    	...
			    	<div style="padding-top: 20px;">
							...
							<table class="table" id="table-data" v-cloak>
								...
								<thead>
									<tr>
										...
										<th rowspan="2" width="22%">Nama Debitur</th>
						...
						<template v-if="'{{ $_GET["jenis"] }}' == 'detail'" v-cloak>
							...
							<table class="table" id="table-data" style="margin-top: 30px;" v-if="nextDisabled" v-cloak>
								<thead>
									<tr>
										<th colspan="4"> Total Seluruh Debitur</th>
										<th width="12%" style="text-align: right;">
											@{{ humanizePrice(saldoInfo.gtBelumJatuhTempo) }}
										</th>
										<th width="12%" style="text-align: right;">
	        ...
	        <div class="ez-popup" id="setting-popup">
	            <div class="layout" style="width: 35%; min-height: 250px;">
	                ...
	                <div class="content-popup">
	                	<form id="form-setting" method="get" action="{{ route('laporan.keuangan.piutang') }}">
	                    ...
	                    <div class="col-md-12">
	                        ...
	                        <div class="row mt-form">
	                            <div class="col-md-4">
	                                <label class="modul-keuangan">Type Piutang</label>
	                            </div>
	                        ...
	                        <div class="row mt-form">
	                            ...
	                            <div class="col-md-12">
                                	...
                                	<span style="font-size: 8pt; margin-left: 5px;">Tampilkan Semua Debitur Yang Memiliki Hutang</span>
	                            </div>
	                        </div>
	                        ...
	                        <template v-if='!semua'>
		                        <div class="row mt-form" style="border-top: 1px solid #eee; padding-top: 20px;">
		                            <div class="col-md-4">
		                                <label class="modul-keuangan">Pilih Debitur</label>
		                            </div>
    	...
    	<script type="text/javascript">
			...
			var app = 	new Vue({
				            ...
				            mounted: function(){
				            	...
				            	axios.get('{{route('laporan.keuangan.piutang.data_resource')}}?'+that.url.searchParams)
			                            .then((response) => {
				            ...
				            methods: {
				            	...
				            	downloadPdf: function(evt){
				                    ...
				                    $('#pdfIframe').attr('src', '{{route('laporan.keuangan.piutang.print.pdf')}}?'+that.url.searchParams)
				            	...
				            	downloadExcel: function(evt){
			                        ...
			                        $('#pdfIframe').attr('src', '{{route('laporan.keuangan.piutang.print.excel')}}?'+that.url.searchParams)
				            	},
				            	...
				            	print: function(evt){
				            		...
				            		$('#pdfIframe').attr('src', '{{route('laporan.keuangan.piutang.print')}}?'+that.url.searchParams)
				            	},

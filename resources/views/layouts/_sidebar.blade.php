    ...
    <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;"
        ...
        <div class="sidebar-collapse menu-scroll">
            ...
            <ul id="side-menu" class="nav">
                ...
                <li class="menu-primer {{Request::is('master') ? 'active' : '' || Request::is('master/*') ? 'active' : '' }}"><a
                        href="#"><i class="fa fa-tachometer fa-fw">
                            <div class="icon-bg bg-orange"></div>
                        </i>
                        <span class="menu-title">Master</span><span class="fa arrow"></span>
                        <!-- for filter -->
                        <span class="hidden">Master Data Suplier , Master Data Customer , Master Data Item Bahan Baku ,
                            Master Data Jenis Produksi , Master Data Pegawai , Master Data Akun Keuangan , Master Data
                            Transaksi Keuangan , Master Data Barang</span>
                        <!-- =========== -->
                    </a>
                    <ul class="nav nav-second-level">
                        <li class="menu-sekunder {{ Request::is('master/datasuplier/suplier') ? 'active' : '' || Request::is('master/datasuplier/*') ? 'active' : '' }}"><a
                                href="{{ url('/master/datasuplier/suplier') }}"><span class="submenu-title">Master Data
                                    Suplier</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('master/datasuplier/suplier') ? 'active' : '' || Request::is('master/datasuplier/*') ? 'active' : '' }}"><a
                                href="{{ url('/master/membership/member') }}"><span class="submenu-title">Master Member</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('master/datacust/cust') ? 'active' : '' || Request::is('master/datacust/*') ? 'active' : '' }}"><a
                                href="{{ url('/master/datacust/cust') }}"><span class="submenu-title">Master Data
                                    Customer</span></a>
                        </li>
                        ...
                        <li class="menu-sekunder {{ Request::is('master/modul/keuangan/master/akun') ? 'active' : '' || Request::is('master/modul/keuangan/master/akun/*') ? 'active' : '' }}"><a
                                href="{{ url('master/modul/keuangan/master/akun') }}"><span class="submenu-title">Master
                                    Data Akun Keuangan</span></a>
                        </li>
                        ...
                        <li class="menu-sekunder {{ Request::is('master/item/index') ? 'active' : '' || Request::is('/master/item/*') ? 'active' : '' }}"><a
                                href="{{ url('/master/item/index') }}"><span class="submenu-title">Master Data Barang</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('master/item_titipan/index') ? 'active' : '' || Request::is('/master/item_titipan/*') ? 'active' : '' }}"><a
                                href="{{ url('/master/item_titipan/index') }}"><span class="submenu-title">Master Data
                                    Barang Titipan</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('master/grouphargakhusus/index') ? 'active' : '' || Request::is('master/grouphargakhusus/*') ? 'active' : '' }}"><a
                                href="{{ url('master/grouphargakhusus/index') }}"><span class="submenu-title">Group
                                    Harga Khusus</span></a>
                        </li>
                        ...
                        <li class="{{ Request::is('master/masterproduksi/index') ? 'active' : '' || Request::is('master/masterproduksi/*') ? 'active' : '' }}">
                            <a href="{{ url('master/masterproduksi/index') }}"><span class="submenu-title">Master
                                    Formula</span><span class="hidden">Master</span></a>
                        </li>
                        @endif
                        ...
                        <li class="{{ Request::is('master/divisi/pos/index') ? 'active' : '' || Request::is('master/divisi/pos/*') ? 'active' : '' }}">
                            <a href="{{ url('/master/divisi/pos/index') }}"><span class="submenu-title">Data Divisi &
                                    Posisi</span><span class="hidden">Master</span></a>
                        </li>
                        @endif
                ...
                <li class="menu-primer {{Request::is('purchasing') ? 'active' : '' || Request::is('purcahse-plan/*') ? 'active' : '' || Request::is('purcahse-order/*') ? 'active' : ''  }}"><a
                        ...
                        <!-- for filter -->
                        <span class="hidden">Rencana Bahan Baku Produksi , Rencana Pembelian , Order Pembelian ,
                            Belanja Harian , Return Pembelian</span></a>
                    <!-- ========== -->
                    <ul class="nav nav-second-level">
                        <li class="menu-sekunder {{ Request::is('purchasing/rencanabahanbaku/bahan') ? 'active' : '' || Request::is('purchasing/rencanabahanbaku/*') ? 'active' : '' }}">
                            <a href="{{ url('/purchasing/rencanabahanbaku/bahan') }}"><span class="submenu-title">Rencana
                                    Bahan Baku Produksi</span><span class="hidden">Purchasing</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('purcahse-plan/plan-index') ? 'active' : '' || Request::is('purchasing/rencanapembelian/*') ? 'active' : '' }}">
                            <a href="{{ url('/purcahse-plan/plan-index') }}"><span class="submenu-title">Rencana
                                    Pembelian</span><span class="hidden">Purchasing</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('purcahse-order/order-index') ? 'active' : '' || Request::is('purchasing/order/*') ? 'active' : '' }}">
                            <a href="{{ url('/purcahse-order/order-index') }}"><span class="submenu-title">Order
                                    Pembelian</span><span class="hidden">Purchasing</span></a>
                        </li>
                        ...
                        <li class="{{ Request::is('purchasing/belanjaharian/belanja') ? 'active' : '' || Request::is('purchasing/belanjaharian/*') ? 'active' : '' }}">
                            <a href="{{ url('/purchasing/belanjaharian/belanja') }}"><span class="submenu-title">Belanja
                                    Harian</span><span class="hidden">Purchasing</span></a>
                        </li>
                        @endif
                        <li class="menu-sekunder {{ Request::is('purchasing/returnpembelian/pembelian') ? 'active' : '' || Request::is('purchasing/returnpembelian/*') ? 'active' : '' }}">
                            <a href="{{ url('/purchasing/returnpembelian/pembelian') }}"><span class="submenu-title">Return
                                    Pembelian</span><span class="hidden">Purchasing</span></a>
                        </li>
                        ...
                        <li class="{{ Request::is('purchasing/lap-pembelian/index') ? 'active' : '' || Request::is('purchasing/lap-pembelian/*') ? 'active' : '' }}">
                            <a href="{{ url('/purchasing/lap-pembelian/index') }}"><span class="submenu-title">Laporan
                                    Pembelian</span><span class="hidden">Purchasing</span></a>
                        </li>
                        @endif
                        ...
                        <li class="{{ Request::is('purchasing/pembayaran_hutang') ? 'active' : '' || Request::is('purchasing/pembayaran_hutang/*') ? 'active' : '' }}">
                            <a href="{{ url('/purchasing/pembayaran_hutang/index') }}"><span class="submenu-title">Pelunasan
                                    Hutang</span><span class="hidden">Purchasing</span></a>
                        </li>
                ...
                <li class="menu-primer {{Request::is('inventory') ? 'active' : '' || Request::is('inventory/*') ? 'active' : '' }}"><a
                        ...
                        <!-- for filter -->
                        <span class="hidden">Penerimaan Barang Suplier, Pengiriman Barang Hasil Produksi, Penerimaan
                            Barang Hasil Produksi , Penerimaan Barang Return Customer , Barang Digunakan , Stock Opname</span>
                        <!-- =========== -->
                    </a>
                    <ul class="nav nav-second-level">
                        <li class="menu-sekunder {{ Request::is('inventory/p_suplier/suplier') ? 'active' : '' || Request::is('inventory/p_suplier/*') ? 'active' : '' }}"><a
                                href="{{ url('/inventory/p_suplier/suplier') }}"><span class="submenu-title">Penerimaan
                                    Barang Suplier</span><span class="hidden">Inventory</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('inventory/pengirimanproduksi/pengirimanproduksi') ? 'active' : '' || Request::is('inventory/pengirimanproduksi/*') ? 'active' : '' }}"><a
                                href="{{ url('/inventory/pengirimanproduksi/pengirimanproduksi') }}"><span class="submenu-title">Pengiriman
                                    Hasil Produksi</span><span class="hidden">Inventory</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('inventory/p_hasilproduksi/produksi') ? 'active' : '' || Request::is('inventory/p_hasilproduksi/*') ? 'active' : '' }}"><a
                                href="{{ url('/inventory/p_hasilproduksi/produksi') }}"><span class="submenu-title">Penerimaan
                                    Hasil Produksi</span><span class="hidden">Inventory</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('inventory/stockgudang/index') ? 'active' : '' || Request::is('inventory/stockgudang/*') ? 'active' : '' }}"><a
                                href="{{ url('/inventory/stockgudang/index') }}"><span class="submenu-title">Stock
                                    Gudang</span><span class="hidden">Inventory</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('inventory/b_digunakan/barang') ? 'active' : '' || Request::is('inventory/b_digunakan/*') ? 'active' : '' }}"><a
                                href="{{ url('/inventory/b_digunakan/barang') }}"><span class="submenu-title">Barang
                                    Digunakan</span><span class="hidden">Inventory</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('inventory/stockopname/opname') ? 'active' : '' || Request::is('inventory/stockopname/*') ? 'active' : '' }}"><a
                                href="{{ url('/inventory/stockopname/opname') }}"><span class="submenu-title">Stock
                                    Opname</span><span class="hidden">Inventory</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('inventory/mutasiitembaku') ? 'active' : '' || Request::is('inventory/mutasiitembaku/*') ? 'active' : '' }}"><a
                                href="{{ url('/inventory/mutasiitembaku/index') }}"><span class="submenu-title">Mutasi
                                    Item Bahan Baku</span><span class="hidden">Inventory</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-primer {{Request::is('produksi') ? 'active' : '' || Request::is('produksi/*') ? 'active' : '' }}"><a
                        ...
                        <!-- for filter -->
                        <span class="hidden">Monitoring Order & Stock , Rencana Produksi , Manajemen SPK , Manajemen
                            Output Produksi , Manajemen Sampah (Waste)</span>
                        <!-- ========== -->
                    </a>
                    <ul class="nav nav-second-level">
                        <li class="menu-sekunder {{ Request::is('produksi/monitoringprogress/monitoring') ? 'active' : '' || Request::is('produksi/monitoringprogress/*') ? 'active' : '' }}"><a
                                href="{{ url('/produksi/monitoringprogress/monitoring') }}"><span class="submenu-title">Monitoring
                                    Order & Stock</span><span class="hidden">Produksi</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('produksi/rencanaproduksi/produksi') ? 'active' : '' || Request::is('produksi/rencanaproduksi/*') ? 'active' : '' }}"><a
                                href="{{ url('/produksi/rencanaproduksi/produksi') }}"><span class="submenu-title">Rencana
                                    Produksi</span><span class="hidden">Produksi</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('produksi/spk/spk') ? 'active' : '' || Request::is('produksi/spk/*') ? 'active' : '' }}"><a
                                href="{{ url('/produksi/spk/spk') }}"><span class="submenu-title">Manajemen SPK</span><span
                        ...
                        <li class="menu-sekunder {{ Request::is('produksi/hasil-produksi') ? 'active' : '' }}"><a href="{{ url('produksi/hasil-produksi/index') }}"><span
                                    class="submenu-title">Manajemen Output Produksi</span><span class="hidden">Produksi</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('produksi/waste/waste') ? 'active' : '' || Request::is('produksi/waste/*') ? 'active' : '' }}"><a
                                href="{{ url('/produksi/waste/waste') }}"><span class="submenu-title">Data Actual SPK
                                    (Waste)</span><span class="hidden">Produksi</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-primer {{Request::is('penjualan') ? 'active' : '' || Request::is('penjualan/*') ? 'active' : '' }}"><a
                    ...
                    <ul class="nav nav-second-level">
                        <li class="menu-sekunder {{ Request::is('penjualan/pembayaranpiutang/*') ? 'active' : '' }}"><a
                                href="{{ url('/penjualan/pembayaranpiutang/index') }}"><span class="submenu-title">Pembayaran
                                    Piutang</span><span class="hidden">Penjualan</span></a>
                        ...
                        <li class="menu-sekunder {{ Request::is('penjualan/rencanapenjualan/rencana') ? 'active' : '' || Request::is('penjualan/rencanapenjualan/*') ? 'active' : '' }}"><a
                                href="{{ url('/penjualan/rencanapenjualan/rencana') }}"><span class="submenu-title">Rencana
                                    Penjualan</span><span class="hidden">Penjualan</span></a>
                        </li>
                        <li class="menu-sekunder {{
                            ...
                            || Request::is('penjualan/POSpenjualanToko/*') ? 'active' : ''
                                ...
                                href="{{ url('/penjualan/POSpenjualan/POSpenjualan') }}"><span class="submenu-title">POS
                                    Penjualan Toko / Mobil</span><span class="hidden">Penjualan</span></a>
                        </li>
                        <!--
                        ...
                        <li class="menu-sekunder {{ Request::is('penjualan/pos-pesanan/index') ? 'active' : '' || Request::is('penjualan/pos-pesanan/*') ? 'active' : '' }}"><a
                                href="{{ url('/penjualan/pos-pesanan/index') }}"><span class="submenu-title">POS
                                    Penjualan Pesanan</span><span class="hidden">Penjualan</span></a>
                        </li>

                        <li class="menu-sekunder {{ Request::is('penjualan/barang-titipan/index') ? 'active' : '' || Request::is('penjualan/barang-titipan/*') ? 'active' : '' }}"><a
                                href="{{ url('/penjualan/barang-titipan/index') }}"><span class="submenu-title">Catat
                                    Barang Titipan</span><span class="hidden">Penjualan</span></a>
                        </li>

                        <li class="menu-sekunder {{ Request::is('penjualan/barang-titip/index') ? 'active' : '' || Request::is('penjualan/barang-titip/*') ? 'active' : '' }}"><a
                                href="{{ url('penjualan/barang-titip/index') }}"><span class="submenu-title">Catat
                                    Barang Titip</span></a>
                        </li>
                        ...
                        <li class="menu-sekunder {{ Request::is('penjualan/penjualanmobile/penjualanmobile') ? 'active' : '' || Request::is('penjualan/penjualanmobile/*') ? 'active' : '' }}"><a
                                href="{{ url('/penjualan/penjualanmobile/penjualanmobile') }}"><span class="submenu-title">Laporan
                                    Penjualan Toko</span><span class="hidden">Penjualan</span></a>
                        </li>
                        ...
                        <li class="menu-sekunder {{ Request::is('penjualan/laporan-penjualan-pesanan/index') ? 'active' : '' || Request::is('penjualan/laporan-penjualan-pesanan/*') ? 'active' : '' }}"><a
                                href="{{ url('/penjualan/laporan-penjualan-pesanan/index') }}"><span class="submenu-title">Laporan
                                    Penjualan Pesanan</span><span class="hidden">Penjualan</span></a>
                        </li>
                        ...
                        <li class="menu-sekunder {{ Request::is('penjualan/mutasi-item/index') ? 'active' : '' || Request::is('penjualan/mutasi-item/*') ? 'active' : '' }}"><a
                                href="{{ url('/penjualan/mutasi-item/index') }}"><span class="submenu-title">Mutasi
                                    Item</span><span class="hidden">Penjualan</span></a>
                        </li>

                        <li class="menu-sekunder {{ Request::is('penjualan/manajemenreturn/r_penjualan') ? 'active' : '' || Request::is('penjualan/manajemenreturn/*') ? 'active' : '' }}"><a
                                href="{{ url('/penjualan/manajemenreturn/r_penjualan') }}"><span class="submenu-title">Manajemen
                                    Return Penjualan</span><span class="hidden">Penjualan</span></a>
                        </li>
                ...
                <li class="menu-primer {{Request::is('keuangan') ? 'active' : '' || Request::is('keuangan/*') ? 'active' : '' }}"><a
                        ...
                        <span class="hidden">Manajemen SPK , Proses Input Transaksi , Laporan Hutang Piutang , Laporan
                            Keuangan , Analisa Progress Terhadap Perencanaan , Analisa Net Profit Terhadap OCF ,
                            Analisa Pertumbuhan Aset , Analisa Cashflow , Analisa Common Size dan Index , Analisa Rasio
                            Keuangan , Analisa Three Bottom Line , Analisa ROE</span>
                    </a>
                    <ul class="nav nav-second-level">
                ...
                <li class="menu-primer {{Request::is('system') ? 'active' : '' || Request::is('system/*') ? 'active' : '' }}"><a
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="menu-sekunder {{ Request::is('system/hakakses/akses') ? 'active' : '' || Request::is('system/hakakses/*') ? 'active' : '' }}"><a
                                href="{{ url('/system/hakakses/akses') }}"><span class="submenu-title">Manajemen Hak
                                    Akses</span><span class="hidden">System</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('profil-perusahaan') ? 'active' : '' || Request::is('profil-perusahaan/*') ? 'active' : '' }}"><a
                                href="{{ url('/profil-perusahaan') }}"><span class="submenu-title">Profil
                                    Perusahaan</span><span class="hidden">System</span></a>
                        </li>
                    </ul>
                </li>
                <li class="menu-primer {{Request::is('nabila') ? 'active' : '' || Request::is('nabila/*') ? 'active' : '' }}"><a
                        href="#"><i class="fa fa-fw">N
                            <div class="icon-bg bg-green"></div>
                    ...
                    <ul class="nav nav-second-level">
                        <li class="menu-sekunder {{ Request::is('nabila/belanjamember/index') ? 'active' : '' || Request::is('nabila/membership/*') ? 'active' : '' }}"><a
                                href="{{ url('/nabila/belanjamember/index') }}"><span class="submenu-title">Membership</span><span
                                    class="hidden">Nabila Moslem</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('nabila/belanjakaryawan/index') ? 'active' : '' || Request::is('nabila/belanjakaryawan/*') ? 'active' : '' }}"><a
                                href="{{ url('/nabila/belanjakaryawan/index') }}"><span class="submenu-title">Belanja
                                    Karyawan</span><span class="hidden">Nabila Moslem</span></a>
                        </li>

                        <li class="menu-sekunder {{ Request::is('nabila/belanjareseller/index') ? 'active' : '' || Request::is('nabila/belanjareseller/*') ? 'active' : '' }}"><a
                                href="{{ url('/nabila/belanjareseller/index') }}"><span class="submenu-title">Reseller</span><span
                                    class="hidden">Nabila Moslem</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('nabila/belanjamarketing/index') ? 'active' : '' || Request::is('nabila/belanjamarketing/*') ? 'active' : '' }}"><a
                                href="{{ url('/nabila/belanjamarketing/index') }}"><span class="submenu-title">Marketer
                                    Online</span><span class="hidden">Nabila Moslem</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('nabila/returnpembelian/index') ? 'active' : '' || Request::is('nabila/returnpembelian/*') ? 'active' : '' }}"><a
                                href="{{ url('/nabila/returnpembelian/index') }}"><span class="submenu-title">Return
                                    Pembelian</span><span class="hidden">Nabila Moslem</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('nabila/rencanapembelian/index') ? 'active' : '' || Request::is('nabila/rencanapembelian/*') ? 'active' : '' }}"><a
                                href="{{ url('/nabila/rencanapembelian/index') }}"><span class="submenu-title">Rencana
                                    Pembelian</span><span class="hidden">Nabila Moslem</span></a>
                        </li>
                        <li class="menu-sekunder {{ Request::is('nabila/pembelian/index') ? 'active' : '' || Request::is('nabila/pembelian/*') ? 'active' : '' }}"><a
                                href="{{ url('/nabila/pembelian/index') }}"><span class="submenu-title">Pembelian</span><span
                                    class="hidden">Nabila Moslem</span></a>
                        <li class="menu-sekunder {{ Request::is('nabila/penerimaanbarang/index') ? 'active' : '' || Request::is('nabila/penerimaanbarang/*') ? 'active' : '' }}"><a
                                href="{{ url('/nabila/penerimaanbarang/index') }}"><span class="submenu-title">Penerimaan
                                    Barang</span><span class="hidden">Nabila Moslem</span></a>
                        </li>
                    </ul>
                </li>
            </ul>
